...
* **deps:** bump micromatch from 4.0.7 to 4.0.8 ([20c192e](https://github.com/Alwatr/store/commit/20c192e38f303e1bf1d470f551c258e2f7087c6f)) by @dependabot[bot]
...
* **deps:** bump the github-actions group across 1 directory with 7 updates ([b80580d](https://github.com/Alwatr/store/commit/b80580d0bf760395354f4b40d3c7e7577e3df347)) by @dependabot[bot]

### Dependencies update

* update ([6c5a670](https://github.com/Alwatr/store/commit/6c5a670d8f3a3546010b305f9093ffa9ed919008)) by @AliMD
...
* **deps:** bump the github-actions group across 1 directory with 3 updates ([e34096c](https://github.com/Alwatr/store/commit/e34096c56e7fc0af3402575b0c2d7433d3b648ef)) by @dependabot[bot]
* **lerna:** update ([ab51222](https://github.com/Alwatr/store/commit/ab51222ce7dac522fb4880ef44cd96046e6664ac)) by @

### Dependencies update

* upd ([8529591](https://github.com/Alwatr/store/commit/852959178c4e4c71938dd2a1011d3e9cc3995c21)) by @
...
* **deps:** bump the github-actions group across 1 directory with 5 updates ([b051cd5](https://github.com/Alwatr/store/commit/b051cd515060502f1a101a9c0cc22ec030fb8435)) by @dependabot[bot]
...
- Add new VS Code extensions ([df1914a](https://github.com/Alwatr/store/commit/df1914a06575eb070d6f0eebd1ac34821138ae8d)) by @AliMD
- Add VS Code settings for nginx formatter ([94b861f](https://github.com/Alwatr/store/commit/94b861f87a887fe11857bfc32cd69995474a4281)) by @AliMD
- **deps-dev:** bump the development-dependencies group with 8 updates ([38ac952](https://github.com/Alwatr/store/commit/38ac952981ecdbe3ad2f1290c54a92dde2497f99)) by @dependabot[bot]
- **deps:** update ([8f3edcf](https://github.com/Alwatr/store/commit/8f3edcf8a489927a6c43dfcaa5db88a579ecac80)) by @
- fix storage name ([ed76477](https://github.com/Alwatr/store/commit/ed76477b15a82a117bc48e3b945047a968b7b91e)) by @
- **lerna:** Refactor lerna.json to include chore type in Miscellaneous Chores section ([1750f1a](https://github.com/Alwatr/store/commit/1750f1a74c56f3453574f9a8080b2366d8ddd801)) by @AliMD
...
- **demo:** import path ([13dfd4c](https://github.com/Alwatr/store/commit/13dfd4c379351bade418cb7bc24fdc652d34280f)) by @njfamirm
- **deps:** dev deps ([b129567](https://github.com/Alwatr/store/commit/b12956768b9d60a75c0fdc43774512b86b655f78)) by @AliMD
- **engin5:** Fix import paths in alwatr-store and collection-reference ([4bb206a](https://github.com/Alwatr/store/commit/4bb206a1899befeba8d01ec1af777bef9fe7fb10)) by @AliMD
...
- **engine/store:** pick owner id ([2cb028a](https://github.com/Alwatr/store/commit/2cb028a959f44fc23983e612be072412767b6b05)) by @njfamirm
- **engine5:** enhance logs ([7b3c2d0](https://github.com/Alwatr/store/commit/7b3c2d04d9f493cc0cc6d8f53131b95b2f9a8650)) by @AliMD
- **engine5:** logger scope name ([639bb9c](https://github.com/Alwatr/store/commit/639bb9cc514ac9bffa203cf43a9c60f74642615b)) by @AliMD
- **engine5:** review document reference and fix class names ([0e5a10b](https://github.com/Alwatr/store/commit/0e5a10b3d277a652d91ea633e3bdb445a3e0ec93)) by @AliMD
...
- **engine:** make last auto id optional ([0e80d55](https://github.com/Alwatr/store/commit/0e80d55f28067b0ccd06cbcbf12030e82d6744d5)) by @njfamirm
...
- **reference:** private constructor params ([926aa9d](https://github.com/Alwatr/store/commit/926aa9d06d4bb0ae0e00277cbaba2cb24a67456d)) by @njfamirm
- **reference:** protected method ([ff8ae62](https://github.com/Alwatr/store/commit/ff8ae6235cb71a61f18b69f6f595fde6a065eed1)) by @njfamirm
...
- **reference:** remove extra tsconfig ([5a6f4ef](https://github.com/Alwatr/store/commit/5a6f4efaa625f0d1adb1eb9894fdce7cc6b1a1b2)) by @njfamirm
- **store-reference:** review and refactor collection reference to improve performance and readability ([7b1b34d](https://github.com/Alwatr/store/commit/7b1b34d6830afde4dd0c477a651b2fe9765d3aaf)) by @AliMD
- **store-reference:** type casting in set method ([81f0ef2](https://github.com/Alwatr/store/commit/81f0ef2a4ac8881643c6c4965d265a803b67f6d7)) by @AliMD
...
- **workflow:** service name ([888fa85](https://github.com/Alwatr/store/commit/888fa85db6d03dc5cf915ca4da0960e0ff55b81f)) by @AliMD

### Features

- **demo:** Add multi-write functionality to node-fs demo ([8839ef8](https://github.com/Alwatr/store/commit/8839ef8bd928c45dd2875d0959c131c43e95963e)) by @AliMD
- **doc-ref:** refactor and isolate apis ([e0085d9](https://github.com/Alwatr/store/commit/e0085d918afe2e611fabd41294bfd070a241e970)) by @AliMD
- **engin5:** Add CollectionReference and defineCollection method ([25dd254](https://github.com/Alwatr/store/commit/25dd254c9c346b9622db678188bf7bf46624ce7f)) by @AliMD
- **engin5/util:** add new parseJson, jsonStringify, readFile, readJsonFile, writeFile, handleExistsFile, writeJsonFile ([bbb4626](https://github.com/Alwatr/store/commit/bbb46269c981327d022b8e283107449c3cb0f83f)) by @AliMD
- **engin5:** add get and writeContext with review all apis and documention ([7594612](https://github.com/Alwatr/store/commit/7594612ac9bffc6a173b3000a6c50824c200dcfa)) by @AliMD
- **engin5:** Add MaybePromise type definition ([55b49ca](https://github.com/Alwatr/store/commit/55b49ca09e1a80c7d84afe3245bb5caf17db76fe)) by @AliMD
- **engin5:** Add owner ID validation for PerUser, PerToken, and PerDevice regions ([79b2ec7](https://github.com/Alwatr/store/commit/79b2ec7cd0927bc0c5b985894e4f9e877954f6fe)) by @AliMD
- **engin5:** Add support for auto-incrementing IDs in CollectionReference ([e883af6](https://github.com/Alwatr/store/commit/e883af67318708df032af06df02db7dd45fde248)) by @AliMD
- **engin5:** add utility functions for reading and writing JSON files ([71f8037](https://github.com/Alwatr/store/commit/71f8037f13c3479c74f5ff533d7a2b81229213a2)) by @AliMD
- **engin5:** Enhance AlwatrStore read and write methods ([2bca22a](https://github.com/Alwatr/store/commit/2bca22a2050458c89581b8aeca32499f92e098b0)) by @AliMD
- **engin5:** fix issues to improve performance and readability ([64b47fc](https://github.com/Alwatr/store/commit/64b47fcdf9794e32f55aa2322140301a01bf3dd4)) by @AliMD
- **engin5:** refactor AlwatrStore with root db as collection, and handle save and syncLoad context ([efe9a1d](https://github.com/Alwatr/store/commit/efe9a1d72dfc381f02b033ce78f1c0b944692c83)) by @AliMD
- **engin5:** Refactor collection and document demo ([0bb2fd4](https://github.com/Alwatr/store/commit/0bb2fd46b4b8d6ed0f4bbdf7b9c75e9126462039)) by @AliMD
- **engin5:** Refactor error handling in collection and document references ([1044c29](https://github.com/Alwatr/store/commit/1044c29e3ca3254f840d3c53ff5821e0e5f8838e)) by @AliMD
- **engin5:** Refactor logging statements in collection and document references ([636175f](https://github.com/Alwatr/store/commit/636175f93958d3c66dd64069720dd02418ce2f22)) by @AliMD
- **engin5:** Update collection reference methods for retrieving items and IDs ([aaa84a7](https://github.com/Alwatr/store/commit/aaa84a7ba36c30a5f38504076eb12a8af67290f0)) by @AliMD
- **engin5:** Update file imports and variable names in demos ([82705b6](https://github.com/Alwatr/store/commit/82705b62b8e1abc7b8b3694cac98aca33edaaef3)) by @AliMD
- **engin5:** Update store file location and owner identifiers ([614d56f](https://github.com/Alwatr/store/commit/614d56f80171dd1d1feb2bb62fc0db5cffb8ab7f)) by @AliMD
- **engin5:** Update StoreFileTTL and CollectionItemMeta types ([5484c96](https://github.com/Alwatr/store/commit/5484c964bd20e40925bcc7f14895a8be79fbda76)) by @AliMD
- **engin5:** Update WriteFileMode enum values ([acaa608](https://github.com/Alwatr/store/commit/acaa6089c2b6d69e1697c4218bcf7cfcdf5233ee)) by @AliMD
...
- **engine5:** add exists and refactor stat ([9e6e4d2](https://github.com/Alwatr/store/commit/9e6e4d21d702272f83bfcf8b9b587299a250c754)) by @AliMD
- **engine5:** Add global variable for package version in logger.ts ([eca7f69](https://github.com/Alwatr/store/commit/eca7f698d89560af88990c0765b1592db168c5ed)) by @AliMD
- **engine5:** AlwatrStore class with complete new api ([c5e4009](https://github.com/Alwatr/store/commit/c5e40099df81e7584d86e21bb8f3e327fd66ab17)) by @AliMD
- **engine5:** design final demo api ([8a9477a](https://github.com/Alwatr/store/commit/8a9477a20c7219e166360999860db4beb679024e)) by @AliMD
- **engine5:** design new concept ([552e96f](https://github.com/Alwatr/store/commit/552e96f592abc0f9c245d02c010baa5a1dd51f44)) by @AliMD
- **engine5:** design new data types ([1c0be8b](https://github.com/Alwatr/store/commit/1c0be8b9901b6e7ed5703aace29379ee04432cf2)) by @AliMD
- **engine5:** DocumentReference class to handle document operations ([1edc32f](https://github.com/Alwatr/store/commit/1edc32fe8cc654dd3801ad3ff066cbc361f444aa)) by @AliMD
- **engine5:** Import CollectionReference and update version string ([61873ce](https://github.com/Alwatr/store/commit/61873ce110c7c0ebe5a84eb9843a30e55a7fda79)) by @AliMD
- **engine5:** import from workspace package ([6e74e9e](https://github.com/Alwatr/store/commit/6e74e9e5ea9d9937e70acb423fa4aaab6715378f)) by @njfamirm
- **engine5:** logger and deepClone utility functions ([1946e58](https://github.com/Alwatr/store/commit/1946e58a412e3cd28e1a09fbfa7f62ccaa4ab0a2)) by @AliMD
- **engine5:** Refactor defineDoc to defineDocument in demo-doc.ts ([cbe113e](https://github.com/Alwatr/store/commit/cbe113ed4a8265a29e99a9efd79fb81d63e0f5cc)) by @AliMD
- **engine5:** Refactor file writing logic in util.ts ([1dac52a](https://github.com/Alwatr/store/commit/1dac52aba5b3b3a175a8b3e8fad22255f6c5c330)) by @AliMD
- **engine5:** Update CollectionReference class with new properties and methods ([82d9a5e](https://github.com/Alwatr/store/commit/82d9a5ea5a96d89d99593997cf4ff3adf6f29b40)) by @AliMD
- **engine5:** Update DocumentReference class with new properties and methods ([4c14739](https://github.com/Alwatr/store/commit/4c147390923ee81fd4d552220778a4e11d7a3162)) by @AliMD
- **engine5:** Update enum values in type.ts ([fe5e1af](https://github.com/Alwatr/store/commit/fe5e1af4e95cc16e14594f122e3fb3c190898c39)) by @AliMD
- **engine5:** Update logger method call in rootStoreUpdated\_() ([70b0ee6](https://github.com/Alwatr/store/commit/70b0ee6704fa5f1c685a124ac4e46ae7583ceed0)) by @AliMD
- **engine5:** Update StoreFileMeta interface in type.ts ([f7be2ac](https://github.com/Alwatr/store/commit/f7be2ac34c9ed87ea00ceabad2ab8451cfa2939d)) by @AliMD
- **engine5:** update updatedCallback parameter in CollectionReference and DocumentReference ([043ef26](https://github.com/Alwatr/store/commit/043ef26db62fda0fb05dac1e7e587479430bc75a)) by @AliMD
- **engine5:** use store file id model ([86b75e7](https://github.com/Alwatr/store/commit/86b75e7951520d5b4a3ab45dd3d872d74bd61dd0)) by @njfamirm
...
- **engine:** cjs build support ([74cce67](https://github.com/Alwatr/store/commit/74cce67ed6686483c2cd57c9a8bd263d71fbd6e3)) by @njfamirm
- **engine:** col demo ([3a41adb](https://github.com/Alwatr/store/commit/3a41adb0b1b6dacbc3f2028294c438a5ec866a4e)) by @njfamirm
...
- **engine:** use owner id in all functions ([967c346](https://github.com/Alwatr/store/commit/967c346df548e6f016c4291638b45e68aa55d248)) by @njfamirm
...
- **reference:** demo ([ed82924](https://github.com/Alwatr/store/commit/ed82924a073dda6e4ff30c1dd73ec27c82eede60)) by @njfamirm
- **reference:** enhance logging ([4eab5a2](https://github.com/Alwatr/store/commit/4eab5a277f1bf818fdba2e49ae3ecf0d7e68b4f7)) by @AliMD
- **reference:** package structure ([070ba0e](https://github.com/Alwatr/store/commit/070ba0ef5a8b8197e473cba4f4aa5d245fcbec3a)) by @njfamirm
...
- **reference:** support store file id ([b7a8c33](https://github.com/Alwatr/store/commit/b7a8c33b1df6031c5827c3f0685d2a32352c4061)) by @njfamirm
- **store-engine:** add new store-engine package for v5 ([97b00d6](https://github.com/Alwatr/store/commit/97b00d62caaa931c50062942aa8668b50bdf24f1)) by @AliMD
- **store-reference:** Add utility functions for converting StoreFileId and StoreFileStat to string IDs and paths ([3343136](https://github.com/Alwatr/store/commit/3343136a481a0bfa15c6c8f8ec64ce31387a8887)) by @AliMD
- **store-reference:** debounce the updates ([6ec562c](https://github.com/Alwatr/store/commit/6ec562cee30e244b764bfe0d94f9125272eca4d4)) by @AliMD
- **store-reference:** Fix import and add new utility function ([60f25ce](https://github.com/Alwatr/store/commit/60f25ce8d8e9dedfe1cf663862b5952d64c9d0ec)) by @AliMD
- **store-reference:** Fix import paths in collection-reference.ts and document-reference.ts ([51b47ea](https://github.com/Alwatr/store/commit/51b47ea4d19f30036ddad437cbb1fe89c1fe1134)) by @AliMD
- **store-reference:** Fix import statements and add utility functions ([b323110](https://github.com/Alwatr/store/commit/b3231107f5867976074092b77ca26957c0976a81)) by @AliMD
- **store-reference:** new package for doc-ref and col-ref ([13303b5](https://github.com/Alwatr/store/commit/13303b53bd677b24158f0dc69b55cdcc2520576d)) by @AliMD
- **store-reference:** Refactor document reference class and import types ([eb2a2e0](https://github.com/Alwatr/store/commit/eb2a2e09edd325cc6e79dc5a57dc7b2859dc639f)) by @AliMD
...
- **api:** dockerfile label ([f6c9d03](https://github.com/Alwatr/store/commit/f6c9d034a91a3df3c85552f68092b312bb53304a)) by @AliMD
- definePackage without scope ([71d1b2d](https://github.com/Alwatr/store/commit/71d1b2d5d062911fefb9d2e8bdb9eb4026934613)) by @njfamirm
- dockerfile labels ([289057c](https://github.com/Alwatr/store/commit/289057c9cf979d9d33813c826943ede13e3c6a01)) by @AliMD
...
- **demo:** build ([80735fd](https://github.com/Alwatr/store/commit/80735fde1bfde0b8d7c3e270ef3bbbfe359bff91)) by @AliMD
- **sdk:** AlwatrStorage class name ([7e0d238](https://github.com/Alwatr/store/commit/7e0d2389d1fff0929a75adcf8c2419126a685c5a)) by @AliMD
- **sdk:** main file name ([3c55f58](https://github.com/Alwatr/store/commit/3c55f580bc18610ca1fd3dbe261a30d3cbe8fcae)) by @AliMD

# [4.0.0](https://github.com/Alwatr/store/compare/v4.0.0-rc.0...v4.0.0) (2023-11-27)

### Bug Fixes

- **api:** docker build issue ([cd70ee6](https://github.com/Alwatr/store/commit/cd70ee672150ea3e0de756183383e3d01a8fd59e)) by @AliMD
- **api:** server script ([4636a43](https://github.com/Alwatr/store/commit/4636a4308c7498c197bf2321dd4b47b7fe5a2d8e)) by @AliMD
- **nginx:** dockerfile ([0aa05ba](https://github.com/Alwatr/store/commit/0aa05ba6f6198a2b70f0be3ebc16d355f8bf0d1f)) by @AliMD
- **nginx:** review and enhance ([5adf303](https://github.com/Alwatr/store/commit/5adf303c763310de6a9657c07ce1b08bd4993146)) by @AliMD

### Features

- **api:** docker build ([1882f53](https://github.com/Alwatr/store/commit/1882f53db91d3ba35c726a1141bad288f8cf972a)) by @AliMD
- **api:** new build ([41691f4](https://github.com/Alwatr/store/commit/41691f46df64b9424de1eb80a4ed09a8eda48743)) by @AliMD
- **engine:** new build ([2385e76](https://github.com/Alwatr/store/commit/2385e764c08302d587dbee68cafdb9d63b3feeab)) by @AliMD
- **nginx:** accelerated nginx server ([823dc07](https://github.com/Alwatr/store/commit/823dc07759cd6e0da826b4e037d76b5e23bf7d9e)) by @AliMD
- **nginx:** base docker image ([337b88d](https://github.com/Alwatr/store/commit/337b88dc22b6c694f548296e62a3473f54e38ae6)) by @njfamirm
- **sdk:** new build ([08f00b5](https://github.com/Alwatr/store/commit/08f00b54a33493c4938975251ea8660fe58346fd)) by @AliMD
- service dockerfile ([f1cd7df](https://github.com/Alwatr/store/commit/f1cd7dfdd35cbc0e2343f72abf078b6be9714748)) by @njfamirm
